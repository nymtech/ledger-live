...
const account: NymAccount = {
  type: "Account",
  id: "js:2:nym:nym1f9y7wdychcdhwvyrhff3zvs3gy3qxcu2th4g8u:",
  starred: false,
  used: false,
  seedIdentifier:
  ...
  derivationMode: "",
  index: 1,
  freshAddress: "nym1f9y7wdychcdhwvyrhff3zvs3gy3qxcu2th4g8u",
  freshAddressPath: "44'/118'/1'/0/0",
  name: "Nym 2 - Nano X Static Account",
  freshAddresses: [],
  blockHeight: 5417472,
  ...
  currency: {
    ...
    explorerViews: [
      {
        tx: "https://www.mintscan.io/nym/txs/$hash",
        address: "https://www.mintscan.io/nym/validators/$address",
      },
    ],
  },
  ...
  xpub: "nym1f9y7wdychcdhwvyrhff3zvs3gy3qxcu2th4g8u",
  nymResources: {
    delegations: [
      {
        ...
        validatorAddress: "nymvaloper1c4k24jzduc365kywrsvf5ujz4ya6mwympnc4en",
      },
    ],
    redelegations: [],
    unbondings: [],
