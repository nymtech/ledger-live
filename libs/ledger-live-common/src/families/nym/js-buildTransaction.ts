...
export const postBuildTransaction = async (
  ...
  const registry = new Registry([
    ["/nym.staking.v1beta1.MsgDelegate", MsgDelegate],
    ["/nym.staking.v1beta1.MsgUndelegate", MsgUndelegate],
    ["/nym.staking.v1beta1.MsgBeginRedelegate", MsgBeginRedelegate],
    [
