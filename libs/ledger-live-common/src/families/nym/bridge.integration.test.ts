...
const nym: CurrenciesData<Transaction> = {
  FIXME_ignoreAccountFields: [
    "nymResources.unbondingBalance", // They move once all unbonding are done
    "nymResources.pendingRewardsBalance", // They are always movings
    "nymResources.delegations", // They are always movings because of pending Rewards
    "nymResources.redelegations", // will change ince a redelegation it's done
    "nymResources.unbondings", // will change once a unbonding it's done
  ...
  accounts: [
    {
      ...
      raw: {
        id: "libcore:1:nym:nympub1addwnpepqwyytxex2dgejj93yjf0rg95v3eqzyxpg75p2hfr6s36tnpuy8vf5p6kez4:",
        seedIdentifier:
          "0388459b2653519948b12492f1a0b464720110c147a8155d23d423a5cc3c21d89a",
        xpub: "nympub1addwnpepqwyytxex2dgejj93yjf0rg95v3eqzyxpg75p2hfr6s36tnpuy8vf5p6kez4",
        derivationMode: "",
        index: 0,
        freshAddress: "nym1g84934jpu3v5de5yqukkkhxmcvsw3u2ajxvpdl",
        freshAddressPath: "44'/118'/0'/0/0",
        freshAddresses: [
          {
            address: "nym1g84934jpu3v5de5yqukkkhxmcvsw3u2ajxvpdl",
      ...
      transactions: [
        {
          ...
          transaction: (t) => ({
            ...
            recipient: "nym1g84934jpu3v5de5yqukkkhxmcvsw3u2ajxvpdl",
          }),
          expectedStatus: {
            errors: {
        ...
        },
        {
          ...
          transaction: transactionTransformer.fromTransactionRaw({
            amount: "0",
            recipient: "nym108uy5q9jt59gwugq5yrdhkzcd9jryslmpcstk5",
            useAllAmount: true,
            family: "nym",
            networkInfo: null,
            validators: [],
        ...
        },
        {
          ...
          transaction: (t) => ({
            ...
            validators: [
              {
                address: "nymvaloper1grgelyng2v6v3t8z87wu3sxgt9m5s03xfytvz7",
                amount: new BigNumber(100),
              },
            ],
            sourceValidator:
              "nymvaloper1sd4tl9aljmmezzudugs7zlaya7pg2895ws8tfs",
            mode: "redelegate",
          }),
          expectedStatus: (a, t) => {
        ...
        },
        {
          ...
          transaction: (t) => ({
            ...
            validators: [
              {
                address: "nymvaloper1sd4tl9aljmmezzudugs7zlaya7pg2895ws8tfs",
                amount: new BigNumber(100),
              },
            ],
            sourceValidator:
        ...
        },
        {
          ...
          transaction: (t) => ({
            ...
            validators: [
              {
                address: "nym108uy5q9jt59gwugq5yrdhkzcd9jryslmpcstk5",
                amount: new BigNumber(100),
              },
            ],
          }),
        ...
        {
          name: "ClaimReward - not a nymvaloper",
          transaction: (t) => ({
            ...t,
            validators: [
              {
    ...
    },
    {
      FIXME_tests: ["balance is sum of ops"],
      raw: {
        id: "libcore:1:nym:nympub1addwnpepqd3nvwwx39pqqvw88sg409675u6wyt4wtzqyt2t0e9y4629t50cdzftxnvz:",
        seedIdentifier:
          "nympub1addwnpepqd3nvwwx39pqqvw88sg409675u6wyt4wtzqyt2t0e9y4629t50cdzftxnvz",
        name: "Nym Static Account",
        starred: true,
        derivationMode: "",
        index: 0,
        freshAddress: "nym10l6h3qw05u7qduqgafj8wlrx3fjhr8523sm0c3",
        freshAddressPath: "44'/118'/0'/0/0",
        freshAddresses: [],
        blockHeight: 2220318,
        ...
        balance: "1000000",
        spendableBalance: "0",
        xpub: "nympub1addwnpepqd3nvwwx39pqqvw88sg409675u6wyt4wtzqyt2t0e9y4629t50cdzftxnvz",
        nymResources: {
          delegations: [],
          redelegations: [],
          unbondings: [],
